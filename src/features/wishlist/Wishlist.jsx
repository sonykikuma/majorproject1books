...
<div className='row mt-3'>
  ...
  <div className='col-md-4' key={item._id}><Link to={`/products/${item.productId._id}`} style={{textDecoration:"none"}}>
    <div className='card mb-4'  >
      <div className='card-header'>
        <img src={item.productId.coverImageUrl} alt="book image" style={{height:"450px", objectFit:"cover", width:"350px"}} className='img-fluid'/>
      </div>
      ...
      <p>Price: Rs.{item.productId.price}</p></div>
      <div className='container pb-3 d-flex justify-content-between'>
      <button className='' onClick={()=> movetocartHandler(item.productId._id)}>Move to Cart</button>
